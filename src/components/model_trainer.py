    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            X_train, y_train, X_test, y_test = (
                train_array[:,:-1], # remove last column as this is the y
                train_array[:,-1], 
                test_array[:,:-1], 
                test_array[:,-1]
            )
            ...
            # Introduce parameters for hyperparameter training 
            params={
                "Decision Tree": {
            ...
            # Create custom threshold on what is considered a suitable model
